...
<html>
        ...
        <div class="sub-menu">
            <div class="container12">
                <form action="" method="POST">
                    <div class="column2">
                        <input type="text" name="city" id="" placeholder="City" value="" class="small-fld">
                    </div>
                    <div class="column2">
                    ...
                    <div class="column4">
                        <input type="submit" value="Update Results" name="update_results" class="small-btn">
                    </div>               
                </form>
            </div>
        </div>
    <div class="grey-container">
        <div class="container12">
            ...
            <h1 id="full" class="main-title"><strong>100% Matches</strong><span>(People who need what you have, and have what you need.)</span></h1>
            <div class="row">
                <div class="column4">
                    <div class="barter-container">
                        <p class="wantsoffers">Their wants
                            <span>EXERCISE MACHINE, BABY SITTER</span>
                        </p>
                        <p class="wantsoffers">Their offers
                            <span>LAWN MOWING, GENERAL HOUSEWORK, WASHING MACHINE</span>
                        </p>
                        <div class="contact-container">
                            <button type="button">Contact this Person</button>
                        </div>
                        <p class="barter-data">POSTED 15 HOURS AGO - Lonsdale</p>
                    </div>
                </div>
                <div class="column4">
                    <div class="barter-container">
            ...
            <h1 id="half" class="main-title"><strong>50% Matches</strong><span>(They either have what you need, or want what you're offering.)</span></h1>
            <div class="row">
                <div class="column4">
                    <div class="barter-container">
                        <p class="wantsoffers">Their wants

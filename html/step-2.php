    ...
    <body>
        <div class="container12">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="column3">
                        <input type="text" id="" class="large-fld" name="email" value="" placeholder="Email Address">
                    </div>
                    <div class="column3">
                    ...
                    <div class="column3">
                        <input type="submit" value="Let's do this!" class="large-btn large-magnify" name="step2">
                    </div>
                </div>
			</form>
